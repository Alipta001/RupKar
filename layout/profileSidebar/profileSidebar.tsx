...
export default function ProfileSidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden lg:block space-y-6 sticky top-24 h-fit">
        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-green-600 rounded-2xl flex items-center justify-center text-white font-black text-2xl shadow-lg shadow-green-100">
              A
            </div>
            <div>
        ...
        <nav className="bg-white p-2 rounded-3xl border border-gray-100 shadow-sm">
          ...
          <button className="w-full flex items-center gap-4 px-4 py-3 rounded-2xl text-red-500 hover:bg-red-50 transition-all font-bold">
            <LogOut size={20} />
      ...
      <div className="lg:hidden w-full -mx-4 px-4 overflow-x-auto no-scrollbar pb-4 sticky top-16 z-20 bg-gray-50/50 backdrop-blur-sm">
